...
const foodStyle =
  'w-36 h-44 mt-8 bg-gray-500 bg-opacity-40 flex flex-col justify-around items-center rounded-3xl cursor-pointer hover:shadow-2xl hover:bg-opacity-50 ';

function Food({ selecetedCatagory }) {
  const filteredFoods = foods.filter(
    (food) => food.catagory === selecetedCatagory,
  );
  return (
