  ...
  return (
    <div className="lists px-8 h-screen flex flex-col ">
      ...
      <ul className="first flex gap-2 justify-center items-center  ">
        <li className={list} onClick={() => handleClick('coffee')}>
          <img src="/images/1.png" alt="" />
          <p>قهوه</p>
        </li>
        <li className={list} onClick={() => handleClick('spaghetii')}>
          <img src="/images/2.png" alt="" />
          <p>ماکارونی</p>
        </li>
        <li className={list} onClick={() => handleClick('steak')}>
          <img src="/images/3.png" alt="" />
          <p>کباب</p>
        </li>
        <li className={list} onClick={() => handleClick('pizza')}>
          <img src="/images/1.png" alt="" />
          <p>پیتزا</p>
        </li>
      </ul>
